#!/usr/bin/env python3
"""
Extended cross-feature sweep for behind(N=709), near(N=110), beneath(N=341).
Tests features not yet covered: L11_F12278, L9_F387, L9_F7540.
Merges with pre-existing results from other sweeps where available.

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_behind_near_beneath_sweep/
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_behind_near_beneath_sweep")
...
TARGET_RELATIONS = ["behind", "near", "beneath"]

# All 8 features for complete cross-feature sweep
FEATURE_CONFIGS = {
