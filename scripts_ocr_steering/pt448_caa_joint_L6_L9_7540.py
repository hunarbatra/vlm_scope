#!/usr/bin/env python3
"""
Joint alpha × start-layer sweep for L6/F7539 and L9/F7540.

Known best results:
  L6/F7539:  caa_sae_down +3.10%@α=1.5 (default start=6)
  L9/F7540:  caa_sae_down +2.86%@α=0.25 (default start=9); N=35 (fast)

Sweep configs:
  L6:      alpha=[0.5,0.75,1.0,1.5,2.0,3.0]    × start=[0,1,3,5,6,8,10,12]
  L9_7540: alpha=[0.1,0.25,0.5,0.75,1.0,1.5,2.0] × start=[0,1,3,5,7,9,12]

Usage:
    CUDA_VISIBLE_DEVICES=2 python3 pt448_caa_joint_L6_L9_7540.py
...
FEATURES = [
    (6,  7539,  ["left of", "right of"],  +3.10),
    (9,  7540,  ["consists of"],          +2.86),
]
...
def main():
    ...
    print(f"\n{'='*80}")
    print("Joint Alpha×Start Sweep (L6+L9_7540) — Summary")
    print(f"{'='*80}")
    print(f"{'Feature':<20} {'Relation':<30} {'BestΔ':>8} {'α':>6} {'Start':>6} {'Known':>8}")
    print("-" * 80)
