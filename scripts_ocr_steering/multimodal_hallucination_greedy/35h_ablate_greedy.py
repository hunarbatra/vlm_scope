...
Outputs:
  analysis_hallucination/_greedy/ablation_results/responses_L{L}_F{F}.jsonl
  analysis_hallucination/_greedy/ablation_results/vqa_L{L}_F{F}.json
  analysis_hallucination/_greedy/ablation_results/vqa_baseline_gpu{G}.json
