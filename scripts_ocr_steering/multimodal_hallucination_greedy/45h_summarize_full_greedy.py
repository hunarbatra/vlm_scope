...
For each feature F in features_to_ablate.csv:
  1. Read analysis_hallucination/_greedy/ablation_results/responses_L{L}_F{F}.jsonl
...
Output:
  analysis_hallucination/_greedy/final_ablation_table.csv
  analysis_hallucination/_greedy/final_best_per_subcategory.csv
"""
