#!/usr/bin/env python3
"""
Canonical Rimsky-style PAIRED CAA — mix→mix (self-steering).
...
Usage:
    CUDA_VISIBLE_DEVICES=X python3 -B mix448_true_caa_paired_mix_to_mix.py
"""
...
OUT_DIR         = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/mix448_true_caa_paired_mix_to_mix")
...
def main():
    ...
    print("=" * 70)
    print("Canonical PAIRED CAA — mix→mix (self-steering)")
    ...
    # Summary
    print(f"\n{'='*80}")
    print("PAIRED CAA — mix-src → mix  (best Δ across α-sweep per condition)")
    print(f"{'='*80}")
