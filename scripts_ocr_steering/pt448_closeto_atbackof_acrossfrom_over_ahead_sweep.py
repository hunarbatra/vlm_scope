#!/usr/bin/env python3
"""
Cross-feature sweep for close_to(N=93), at_the_back_of(N=94), across_from(N=94),
over(N=84), ahead_of(N=39).
All only ever tested with their single assigned feature. Full 8-feature cross-sweep.

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_closeto_atbackof_acrossfrom_over_ahead_sweep/
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_closeto_atbackof_acrossfrom_over_ahead_sweep")
...
TARGET_RELATIONS = ["close to", "at the back of", "across from", "over", "ahead of"]
