#!/usr/bin/env python3
"""
Alpha sweep for unswept relations: beside, beyond, contains, over, attached to.

beside (N=?) — L15_F220 assigned
beyond (N=?) — L12_F2257 assigned
contains (N=?) — L15_F220 assigned
over (N=?) — L15_F220 assigned
attached to (N=?) — L9_F387 assigned

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_unswept_relations/
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 pt448_unswept_relations.py
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_unswept_relations")
...
TARGET_RELATIONS = [
    "beside",      # L15_F220 assigned
    "beyond",      # L12_F2257 assigned
    "contains",    # L15_F220 assigned
    "over",        # L15_F220 assigned
    "attached to", # L9_F387 assigned
]

FEATURE_CONFIGS = {
    "L15_F220":   {"layer": 15, "feature": 220,   "start": 15, "oracle_alpha": 0.7,
                   "alphas": [0.3, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.25, 1.5, 2.0]},
    ...
    "L9_F7540":   {"layer": 9,  "feature": 7540,  "start": 9,  "oracle_alpha": 0.25,
                   "alphas": [0.1, 0.15, 0.2, 0.25, 0.4, 0.6]},
}
