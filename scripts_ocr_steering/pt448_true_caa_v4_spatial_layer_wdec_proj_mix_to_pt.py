#!/usr/bin/env python3
"""
True CAA SPATIAL_LAYER + W_dec[F] PROJECT+AMPLIFY — mix-src → steer pt-448.
...
Usage:
    CUDA_VISIBLE_DEVICES=X python3 -B pt448_true_caa_v4_spatial_layer_wdec_proj_mix_to_pt.py
"""
...
OUT_DIR         = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_true_caa_v4_spatial_layer_wdec_proj_mix_to_pt")
...
def main():
    ...
    print("=" * 70)
    print("True CAA SPATIAL_LAYER + W_dec[F] PROJ+AMPLIFY β=3 — mix-src → steer pt-448")
    print("=" * 70, flush=True)
    ...
    print(f"\n{'='*70}")
    print(f"True CAA SPATIAL_LAYER_WDEC_PROJ β={BETA} — mix→pt-448")
    print(f"{'='*70}")
