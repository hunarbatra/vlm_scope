#!/usr/bin/env python3
"""
Cross-feature sweep for touching(N=1281), below(N=277), above(N=341).
These high-N relations are assigned to L11/L6/L15 but never fully compared against all features.

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_touching_below_above_sweep/
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_touching_below_above_sweep")
...
TARGET_RELATIONS = ["touching", "below", "above"]
