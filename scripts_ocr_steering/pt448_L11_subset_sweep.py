#!/usr/bin/env python3
"""
Fine alpha sweep for L11/F12278 on own-relation subset ("touching").

Correct methodology: evaluate on per-relation subset only, not full VSR.
L11/F12278 own_rels=["touching"], natural start=5.

Alphas: 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.9, 1.0, 1.25, 1.5, 2.0

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_L11_subset_sweep/
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 pt448_L11_subset_sweep.py
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_L11_subset_sweep")
...
def main():
    ...
    # Build subset indices for own-rels
