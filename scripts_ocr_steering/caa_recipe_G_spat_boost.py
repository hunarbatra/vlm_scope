...
OUT_DIR = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/caa_recipe_G_spat_boost")
...
def main():
    ...
    test_vis_full = list(range(len(vsr_all)))
    ...
    shared_path = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/caa_recipe_compare_mix_to_pt/results.json")
    shared = {}
