#!/usr/bin/env python3
"""Re-extract SAE acts for L17_F13602 and L21_F9577 under 'ocr' prompt."""
...
FEATURES = [
    {"layer": 17, "feature": 13602},
    {"layer": 21, "feature": 9577},
]
...
def main():
    ...
    for feat in FEATURES:
        ...
        print(f"\n[EXTRACT/ocr-prompt] {key} across {len(ds)} samples...", flush=True)
