#!/usr/bin/env python3
"""Drill into L15_F220 with wider γ sweep: γ ∈ {2, 5, 7, 15, 20, 30} on top of BACKBONE α=1."""
...
OUT_DIR = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/caa_L15_F220_drill")
