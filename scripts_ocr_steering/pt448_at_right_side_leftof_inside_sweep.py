#!/usr/bin/env python3
"""
Cross-feature sweep for at_the_right_side_of(N=480), left_of(N=210), inside(N=240).
Tests features not yet covered by prior sweeps.

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_at_right_side_leftof_inside_sweep/
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_at_right_side_leftof_inside_sweep")
...
TARGET_RELATIONS = ["at the right side of", "left of", "inside"]
