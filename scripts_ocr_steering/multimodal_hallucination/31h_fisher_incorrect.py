...
Outputs:
  analysis_hallucination/halluc_pertoken/halluc_features_pertoken.csv
  analysis_hallucination/halluc_pertoken/all_features_stats_pertoken.csv
  analysis_hallucination/halluc_pertoken_by_subcat/halluc_features_<CAT>.csv   (per category)
...
UNSAFE_DIR = ROOT / "analysis_hallucination" / "firing_incorrect_pertoken"
CAT_DIR    = ROOT / "analysis_hallucination" / "firing_incorrect_by_subcat"
OUT_ALL    = ROOT / "analysis_hallucination" / "halluc_pertoken"
OUT_CAT    = ROOT / "analysis_hallucination" / "halluc_pertoken_by_subcat"
