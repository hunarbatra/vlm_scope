...
Outputs:
  analysis_hallucination/final/final_halluc_features.csv           (overall)
  analysis_hallucination/final/final_halluc_features_<CAT>.csv     (per category)
  analysis_hallucination/final/summary.json
"""
import json
...
LEX_DIR       = ROOT / "analysis_hallucination" / "lexical"
CAT_DIR       = ROOT / "analysis_hallucination" / "halluc_pertoken_by_subcat"
OUT_DIR       = ROOT / "analysis_hallucination" / "final"
