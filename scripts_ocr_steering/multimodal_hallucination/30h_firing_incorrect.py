...
Outputs:
  analysis_hallucination/firing_incorrect_pertoken/firing_halluc_layer_L.json
  analysis_hallucination/firing_incorrect_by_subcat/firing_halluc_<SUBCAT>_layer_L.json
"""
