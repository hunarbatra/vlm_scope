...
Outputs:
  analysis_hallucination/ablation_input/features_to_ablate.csv
  analysis_hallucination/ablation_input/selection_summary.json
"""
...
FINAL_CSV   = ROOT / "analysis_hallucination" / "final" / "final_halluc_features.csv"
FINAL_DIR   = ROOT / "analysis_hallucination" / "final"
SC_DIR      = ROOT / "analysis_hallucination" / "halluc_pertoken_by_subcat"
HALLUC_CSV  = ROOT / "analysis_hallucination" / "halluc_pertoken" / "halluc_features_pertoken.csv"
ADAPTED_CSV = ROOT / "analysis" / "adapted" / "adapted_features_results.csv"
OUT_DIR     = ROOT / "analysis_hallucination" / "ablation_input"
