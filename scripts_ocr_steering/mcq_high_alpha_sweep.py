#!/usr/bin/env python3
"""Extended MCQ sweep: very high α and γ to push past +2.06pp."""
...
OUT_DIR      = SAE_ROOT / "analysis_ocr/mcq_high_alpha"
...
# AGGRESSIVE alphas/gammas — push past previous +2.06pp peak
ALPHAS = [10.0, 20.0, 30.0, 50.0, 100.0, 200.0]
...
def main():
    ...
    print(f"=== HIGH-α MCQ {key} ===", flush=True)
    ...
    # Skip A_MIDDLE — focus on D (winner shape from previous run)
    for a in ALPHAS:
        for g in GAMMAS:
            rk = f"D_a{a}_g{g}"
