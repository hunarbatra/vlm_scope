#!/usr/bin/env python3
"""
Cross-feature sweep for under(N=589), on_top_of(N=505), surrounding(N=90).
All assigned to L11_F12278 but never cross-feature compared.

Output: /data1/vlm_scope_sae_mix448_textonly/analysis/pt448_under_ontop_sweep/
"""
...
OUT_DIR     = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_under_ontop_sweep")
...
TARGET_RELATIONS = ["under", "on top of", "surrounding"]

FEATURE_CONFIGS = {
    "L11_F12278": {"layer": 11, "feature": 12278, "start": 5,  "oracle_alpha": 0.45,
                   "alphas": [0.2, 0.3, 0.4, 0.45, 0.5, 0.6, 0.75, 1.0]},
