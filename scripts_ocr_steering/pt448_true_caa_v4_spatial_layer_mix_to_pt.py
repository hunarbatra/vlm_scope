#!/usr/bin/env python3
"""
True CAA SPATIAL_LAYER condition — mix-src → steer pt-448.
...
OUT_DIR        = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_true_caa_v4_spatial_layer_mix_to_pt")
...
def main():
    ...
    print("=" * 70)
    print("True CAA SPATIAL_LAYER — mix-src → steer pt-448")
    ...
    # Summary
    print(f"\n{'='*70}")
    print("True CAA SPATIAL_LAYER — mix→pt-448")
    print(f"{'='*70}")
