#!/usr/bin/env python3
"""
True CAA SPATIAL_LAYER + W_dec[F] BOOSTED — mix-src → steer pt-448.
...
Usage:
    CUDA_VISIBLE_DEVICES=X python3 -B pt448_true_caa_v4_spatial_layer_wdec_boost_mix_to_pt.py
"""
...
OUT_DIR         = Path("/data1/vlm_scope_sae_mix448_textonly/analysis/pt448_true_caa_v4_spatial_layer_wdec_boost_mix_to_pt")
...
def main():
    ...
    print("=" * 70)
    print("True CAA SPATIAL_LAYER + W_dec[F] BOOST β=3 — mix-src → steer pt-448")
    print("=" * 70, flush=True)
